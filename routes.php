...
// Educations
$router->get('education/create', 'App/Controllers/EducationController.php@create', ['create' => Permissions::class]);
$router->get('education/{id}', 'App/Controllers/EducationController.php@show', ['read' => Permissions::class]);
...
$router->post('education/{id}/store', 'App/Controllers/EducationController.php@store', [
